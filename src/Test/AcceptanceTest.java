...
//    }
    ...
    public void testEntities(){
        ...
        for (int i = 1; i < gameBoard.getBoard().length; i++){
            assertNotNull(gameBoard.getField(i));
        ...
        assertTrue(gameBoard.getField(1) instanceof Territory);
        assertTrue(gameBoard.getField(2) instanceof Territory);
        assertTrue(gameBoard.getField(3) instanceof Fleet);
        assertTrue(gameBoard.getField(4) instanceof Tax);
        assertTrue(gameBoard.getField(5) instanceof Territory);
        assertTrue(gameBoard.getField(6) instanceof Refuge);
        assertTrue(gameBoard.getField(7) instanceof Territory);
        assertTrue(gameBoard.getField(8) instanceof Territory);
        assertTrue(gameBoard.getField(9) instanceof Fleet);
        assertTrue(gameBoard.getField(10) instanceof LaborCamp);
        assertTrue(gameBoard.getField(11) instanceof Territory);
        assertTrue(gameBoard.getField(12) instanceof Territory);
        assertTrue(gameBoard.getField(13) instanceof Territory);
        assertTrue(gameBoard.getField(14) instanceof LaborCamp);
        assertTrue(gameBoard.getField(15) instanceof Fleet);
        assertTrue(gameBoard.getField(16) instanceof Tax);
        assertTrue(gameBoard.getField(17) instanceof Territory);
        assertTrue(gameBoard.getField(18) instanceof Territory);
        assertTrue(gameBoard.getField(19) instanceof Territory);
        assertTrue(gameBoard.getField(20) instanceof Fleet);
        assertTrue(gameBoard.getField(21) instanceof Refuge);
